...
GENERATED="${GOPATH}/src/github.com/evoaway/erc20-transfers-storage-svc/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/evoaway/erc20-transfers-storage-svc/docs/web_deploy"
